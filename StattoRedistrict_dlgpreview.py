...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'StattoRedistrict_dlgpreview.ui'))


class StattoRedistrictDlgPreview(QDockWidget, FORM_CLASS):

    closingPlugin = pyqtSignal()

    def __init__(self, parent=None):
        """Constructor."""
        super(StattoRedistrictDlgPreview, self).__init__(parent)
